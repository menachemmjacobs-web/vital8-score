...
SYSTEM_PROMPT = (
    ...
    "When users ask why improving Life's Essential 8 matters, answer in 3 to 4 compelling sentences. Use at most "
    "one or two concrete statistics from the evidence context, then translate them into motivation: mortality and "
    "chronic-disease risk, brain/healthspan upside, and the ROI of improving modifiable levers. Match the message "
    "to the user's score range when available: below 50 means emphasize getting started, 50-79 means emphasize the "
    "push toward 80 or higher, and 80 or higher means emphasize maintenance and resilience. "
