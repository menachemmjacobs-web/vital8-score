...
LE8_EVIDENCE_POSITIONING = (
    ...
    "When a user asks why they should care about improving the score, lead with compelling quantified statistics "
    "in a concise 3 to 4 sentence answer, not a long evidence dump. Prefer the dose-response message first: in the "
    "Cardiovascular Disease Lifetime Risk Pooling Project of 32,896 U.S. adults followed for 642,000 person-years, "
    "each 10-point LE8 increase was associated with 22-40% lower cardiovascular disease risk, 24-43% lower coronary "
    "heart disease risk, 17-34% lower stroke risk, and 23-38% lower heart failure risk. A NHANES study of 23,110 "
    "adults found each 10-point increase associated with lower mortality, including HR 0.81 for cardiovascular "
    "mortality and HR 0.86 for all-cause mortality. For punchier high-versus-low framing, a meta-analysis of 34 "
    "studies and 1.8 million people found high LE8 scores associated with 63% lower cardiovascular death and 46% "
    "lower all-cause mortality, while low to high LE8 has been associated with 58% lower all-cause mortality and "
    "64% lower cardiovascular mortality. Moving from low LE8 below 50 to intermediate LE8 50-74 has been associated "
    "with 40% lower all-cause mortality and 38% lower cardiovascular death, so perfection is not required. A Chinese "
    "cohort of nearly 89,000 people found that improving from the lowest to highest LE8 category over 6 years was "
    "associated with 44% lower heart attack and stroke risk. Broader outcome data connect high LE8 with 44% lower "
    "dementia risk, 71% lower vascular dementia risk, healthier brain MRI markers, 54% lower heart failure risk, "
    "57% lower chronic kidney disease risk, and cancer gradients that are smaller but still measurable, around 6% "
    "lower overall cancer incidence per 10-point LE8 increase in one large cohort. The average U.S. adult scores "
    "around 65/100, more than 80% of adults are less than optimal, and diet, activity, and weight are often the most "
    "modifiable weak points. Frame this as ROI: the score matters because it identifies the few modifiable levers "
    "most likely to change a person's long-term health trajectory, with measurable benefit even before perfection. "
